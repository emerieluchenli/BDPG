...
class Trainer(BaseTrainer):
    def __init__(self, sess, model, args=None):
        ...
        self.sess = sess
        self.num_steps = self.model.num_steps  # unroll, not necessarily bootstrap n
    ...
    def train(self, env):
        ...
        self.bc = int(self.num_steps * self.env.num_envs)
    ...
    def __rollout(self):
        ...
        if self.model.is_exploring:
            ...
            info_gain = self.model.step_policy.get_info_gain(mb_obs.reshape(train_input_shape), mb_returns.flatten())
        ...
        self.mb_obs = mb_obs.swapaxes(1, 0).reshape(train_input_shape)
